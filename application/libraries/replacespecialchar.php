      ...
      class replacespecialchar 
    {
        ...
        public function replaceSpecialCharOrMaster($array)
        {
           ...
           for($x=0;$x<count($array);$x++)
           {
                   ...
                   $entries[$x]['fullname'] = strtr(htmlentities(utf8_decode($array[$x]['fullname'])),$trans);
                   $entries[$x]['branch_name'] = $array[$x]['branch_name'];
                   $entries[$x]['vat_code'] = $array[$x]['vat_code'];
                   $entries[$x]['or_cmfvatrate'] = $array[$x]['or_cmfvatrate'];
                   $entries[$x]['productx'] = $array[$x]['productx'];
                   $entries[$x]['or_wtaxpercent'] = $array[$x]['or_wtaxpercent'];
                   $entries[$x]['subscription'] = $array[$x]['subscription'];
           }
        ...
        public function replaceSpecialCharOrMasterIESAdv($array)
        {
              $trans = array("&amp;" => "&",'&Ntilde;'=>'N',"&ntilde;"=>'n',"?"=>'n','&quot;'=>''); 
