...
if (!function_exists('pages'))
{
    function pages($total = 20, $page = null, $limit = 10, $length = 10)
    {
        ...
        if ($pages < $length) { // simple pagination
            ...
            $html[] = "<li value='$prev'><a href='$url?page=$prev'>&lt;</a></li>";
            
            $html[] = "<li value='$next'><a href='$url?page=$next'>&gt;</a></li>";
            
        } else {
            
            $html[] = "<li value='1'><a href='$url?page=1'>&lt;&lt;</a></li>";
            ...
            for ($i = $lbound; $i <= $hbound; $i++) {
                ...
                $html[] = "<li value='$i'><a class='$class' href='$href'>$i</a>";
            }
            
            $html[] = "<li value='$next'><a href='$url?page=$next'>&gt;</a></li>";
        
            $html[] = "<li value='$pages'><a href='$url?page=$pages'>&gt;&gt;</a></li>";
        }
