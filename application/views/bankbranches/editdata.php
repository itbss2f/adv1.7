<div class="block-fluid">      
    <form action="<?php echo site_url('bankbranch/update/'.$data['id']) ?>" method="post" name="formsave" id="formsave"> 
...
$("#save").click(function() {
    var countValidate = 0;  
    var validate_fields = ['#bbf_bank', '#bbf_bnch', '#bbf_add1', '#bbf_tel1', '#bbf_name'];
