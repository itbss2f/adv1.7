        ...
        <div class="span12">
            <div class="head">
                <div class="isw-grid"></div>
                    <h1>Aging of Accounts Receivable (Yearly - Summary / Yearly - Detailed / Yearly2 - Summary / Yearly2 - Detailed / Yearly3 - Detailed)</h1>
                    <ul class="buttons">
            ...
            <div class="row-form" style="padding: 2px 2px 2px 10px;">
                ...
                <div class="span2" style="margin-top:12px">
                    <select name="reporttype" id="reporttype">                    
                        <option value="1">Yearly - Summary</option>                        
                        <option value="2">Yearly - Detailed</option>                        
                        <option value="3">Yearly2 - Summary</option>                                                
                        <option value="4">Yearly2 - Detailed</option>                                                
                        <option value="5">Yearly3 - Detailed</option>                                                
                        <option value="6">Yearly - Summary without VAT</option>  
                    </select>
                </div>
...
$("#generatereport").click(function(){
    ...
    if (countValidate == 0) {
        ...
        $.ajax({
            url: "<?php echo site_url('araging_report6/generatereport') ?>",
            type: "post",
            //data: {datefrom: datefrom, dateto: dateto, reporttype: reporttype, edition: edition, dummy: dummy, pay: pay, exclude: exclude},
            data: {},
            success:function(response) {
                    $("#source").attr('src', "<?php echo site_url('araging_report6/generatereport') ?>/"+datefrom+"/"+reporttype+"/"+collast1+"/"+collast2);
                    $(".c_loader").hide();
            }
        });        
    } else {            
