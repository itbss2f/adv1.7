...
<img src="http://ies.inquirer.com.ph/invoiceattachment/<?php echo $file['filename']?>">

<?php } else if ($file['filetype'] == '.pdf') { ?>

<iframe src="http://ies.inquirer.com.ph/invoiceattachment/<?php echo $file['filename'] ?>" width="900px" height="1200px"></iframe>
