...
<div>
    ...
    <div class="row-form-booking">
        ...
        <div class="span1" style="width:100px"><input type='text' name='supercedingai' id='supercedingai' value="<?php if ($print['ao_rfa_supercedingai'] != '') { echo $print['ao_rfa_supercedingai']; } else { echo str_pad($lastinv + 1,8,"0",STR_PAD_LEFT); } ?>" readonly="readonly"></div>    
