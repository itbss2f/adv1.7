...
<?php $book_name = ""; ?>
        ...
        <?php for($ctr = 0 ;$ctr<count($result);$ctr++) { ?>
                    ...
                    <?php if($class_code != $result[$ctr]['book_name']) { ?>
                    
                    <tr style='font-size:15px'>
                    
                    <td colspan='17' id="class_group" style='text-align: left;'><b>*** SECTION <?php echo $result[$ctr]['book_name'] ?> ***</b></td>
                    
                    </tr>
                  
                    <?php $class_code =   $result[$ctr]['book_name']; ?>    
                    ...
                    <?php if($result[$ctr]['book_name'] != $book_name and $ctr != 0) { ?>
