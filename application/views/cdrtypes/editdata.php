<div class="block-fluid">      
    <form action="<?php echo site_url('cdrtype/update/'.$data['id']) ?>" method="post" name="formsave" id="formsave"> 
  <div class="row-form-booking">
        <div class="span2" style="width:120px"><b>Description</b></div>    
        <div class="span2" style="width:190px"><input type="text" name="cdrtype_name" id="cdrtype_name" value="<?php echo $data['cdrtype_name'] ?>"></div>        
        <div class="clear"></div>    
    </div>
    <div class="row-form-booking">
