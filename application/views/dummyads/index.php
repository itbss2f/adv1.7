 ...
 <div class="workplace">
    ...
    <div class="row-fluid">
        ...
        <form id="report_form" action="<?php echo site_url("exdeal_report/generate_report") ?>" method="POST">       
              ...
              <div class="span1" style="width:73px;" ><b>From Date</b></div>    
              ...
              <div class="span2" style="width:70px;"><b>From Product</b></div>
              
              <div class="span2">
              
                      <select data-placeholder="Select a product"  id="from_product" name="from_product" class="chzn-select" style="width100%;">
                          ...
                          <?php if($products[$ctr]['prod_name'] == 'PDI Broadsheet') { ?>
                          
                          <?php $selected = "selected"; ?>  
                          
                          <?php } ?>
                          
                                <option <?php  echo $selected; ?> value="<?php echo $products[$ctr]['prod_name'] ?>"><?php echo $products[$ctr]['prod_name'] ?></option> 
              ...
              <div class="span2" style="width:65px;"><b>To Product</b></div>
              
              <div class="span2">
              
                      <select data-placeholder="Select a product"  id="to_product" name="to_product" class="chzn-select" style="width100%;">
...
{ 
 ...
 function submitform()
 {
     ...
     xhr =  $.ajax({
          url:"<?php echo site_url('dummyad/generateReport') ?>",
          type:"POST",
