...
<form action="<?php echo site_url('dbmemo/saveDBMemoAuto') ?>" method="post" name="saveForm" id="saveForm">
<div class="workplace">
    <div class="row-fluid">
        ...
        <div class="span3">
            ...
            <div class="block-fluid">                        
                ...
                <div class="row-form-booking">
                   ...
                   <div class="span5"><input type="text" name="dcnumber" id="dcnumber" value="AUTO" readonly="readonly"/></div>
                   <div class="clear"></div>
                </div>                                   
        ...
        <div class="span9">
            <div class="head">
                ...
                <ul class="buttons">                    
                    ...
                    <li><a href="#" class="isw-calc" id="b_orcm" title="Lookup OR and CM"></a></li>                               
            ...
            <div class="block-fluid">                                        
                ...
                <div class="row-form-booking">
                   ...
                   <div class="span1"><input id="habol" type="checkbox" style="width: 30px;" value="1" name="habol">Habol</div>
                   <div class="span1"><input id="haboldate" type="text" style="width: 80px;" name="haboldate" placeholder="DATE"></div>
                ...
                <div class="row-form-booking">
                   ...
                   <div class="span6"><input type="text" name="dcamountinwords" id="dcamountinwords"></div>
                   <div class="span1">AR #:</div>
                   <div class="span3"><input type="text" name="refnum" id="refnum"></div>
                   <div class="clear"></div>
                </div> 
                <div class="row-form-booking">
