<div class="block-fluid">      
    <form action="<?php echo site_url('productgroup/save') ?>" method="post" name="formsave" id="formsave"> 
...
$("#save").click(function() {
    ...
    if (countValidate == 0) {
        $.ajax({
            url: "<?php echo site_url('productgroup/validateCode') ?>",
            type: "post",
            data: {code : $("#group_code").val()},
