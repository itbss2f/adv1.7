<div class="block-fluid">      
    <form action="<?php echo site_url('mainproduct/save') ?>" method="post" name="formsave" id="formsave"> 
...
$("#save").click(function() {
    var countValidate = 0;  
    var validate_fields = ['#mprod_code'];
    ...
    if (countValidate == 0) {
        $.ajax({
            url: "<?php echo site_url('mainproduct/validateCode') ?>",
            type: "post",
            data: {code : $("#mprod_code").val()},
