<div class="block-fluid">      
    <form action="<?php echo site_url('con_function/save') ?>" method="post" name="formsave" id="formsave"> 
    <div class="row-form-booking">
        <div class="span2" style="width:120px"><b>Name</b></div>    
        <div class="span2" style="width:190px"><input type="text" name="functionname" id="functionname"></div>        
        <div class="clear"></div>    
    </div>
    <div class="row-form-booking">
