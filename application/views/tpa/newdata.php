<div class="block-fluid">      
    <form action="<?php echo site_url('tpa/save') ?>" method="post" name="formsave" id="formsave"> 
    ...
    <div class="row-form-booking">
        <div class="span3"><button class="btn btn-success" type="button" name="save" id="save">Save New TPA</button></div>        
        <div class="clear"></div>        
    </div>
    </form>
</div>
...
$("#save").click(function() {
    ...
    if (countValidate == 0) {
        $.ajax({
            url: "<?php echo site_url('tpa/validateCode') ?>",
            type: "post",            
            data: {name : $("#name").val()},
