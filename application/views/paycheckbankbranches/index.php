...
$(function() {
    ...
    $('.edit').click(function() {
        var $id = $(this).attr('id');
        $.ajax({
          url: "<?php echo site_url('paycheckbankbranch/editdata') ?>",
          type: "post",
          data: {id: $id},
    ...
    $('.remove').click(function() {
        ...
        if (ans) {
            window.location = "<?php echo site_url('paycheckbankbranch/removeData') ?>/"+$id;
        }
    });

    $('#newdata').click(function(){        
       $.ajax({
          url: "<?php echo site_url('paycheckbankbranch/newdata') ?>",
          type: "post",
          data: {},
          success:function(response) {
             $response = $.parseJSON(response);
    ...
    $('#searchdata').click(function(){        
       $.ajax({
          url: "<?php echo site_url('paycheckbankbranch/searchdata') ?>",
          type: "post",
          data: {},
          success:function(response) {
             $response = $.parseJSON(response);
