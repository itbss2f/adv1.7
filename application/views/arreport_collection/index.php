        ...
        <div class="span12">
            <div class="head">
                <div class="isw-grid"></div>
                    <h1>Accounts Receivable Advertising - Collections</h1>
                    <ul class="buttons">
            ...
            <div class="row-form" style="padding: 2px 2px 2px 10px;">
                ...
                <div class="span2" style="margin-top:12px">
                    <select name="reporttype" id="reporttype">                    
                        ...
                        <option value="5">Adtype - Direct</option>                                                                                                                                                                                                                                                                                                                                                                           
                        <option value="6">Adtype - Agency</option>                                                                                                                                                                                                                                                                                                                                                                           
                        <!--<option value="4">Client Summary</option>-->                                                                                                                                                                                                                                                                                                                                                                           
                        <!--<option value="5">All Agency Summary</option>                                                                                                                                                                                                                                                                                                                                                       
                        <option value="6">All Direct Summary</option>   -->                                                                                                                                                                                                                                                                                                                                                    
                    </select>
                </div>
                <div class="span2" style="width:50px;margin-top:12px">Rank Type</div>
                ...
                <div class="span2" style="width: 80px;margin-top:12px"><button class="btn btn-success" id="exportbutton" type="button">Export</button></div>
...
$("#generatereport").click(function(response) {
    ...
    //window.location
    $("#source").attr('src', "<?php echo site_url('arreport_collection/generatereport') ?>/"+dateasfrom+"/"+dateasof+"/"+reporttype+"/"+ranktype+"/"+agencyfrom+"/"+agencyto+"/"+c_clientfrom+"/"+c_clientto+"/"+ac_agency+"/"+ac_client);     
...
$("#exportbutton").click(function()
  {
    ...
    if (countValidate == 0) {
    
         {
            ...
            window.open("<?php echo site_url('arreport_collection/exportbutton/') ?>?dateasfrom="+dateasfrom+"&dateasof="+dateasof+"&reporttype="+reporttype+"&ranktype="+ranktype+"&agencyfrom="+agencyfrom+"&agencyto="+agencyto+"&c_clientfrom="+c_clientfrom+"&c_clientto="+c_clientto+"&ac_agency="+ac_agency+"&ac_client="+ac_client, '_blank');
            window.focus();
         }  
    }    
