...
<tr style="border-top:1px solid #ccc;margin-top:25px;widdh: 2200px;font-size: 10px;">
        ...
        <td style="text-align: center;width:150px;max-width:150px;"><?php echo $result[$ctr]['or_part'] ?>&nbsp;</td>
        <td style="text-align: center;width:150px;max-width:150px;"><?php echo $result[$ctr]['payment_desc'] ?>&nbsp;</td>
...
<?php if(count($result) > 0){ ?>
    ...
    <tr  style="border-top:1px solid #ccc;margin-top:25px;witdh: 2200px;font-size: 10px;">
        ...
        <td style="text-align: center">&nbsp;</td>
        <td style="text-align: center">&nbsp;</td>
        <td style="text-align: right"><?php echo number_format($result[$ctr]['or_amt'],2,'.',',') ?>&nbsp;</td>
        <td style="text-align: right"><?php echo number_format($result[$ctr]['assign_amt_c'],2,'.',',') ?>&nbsp;</td>
