...
<?php if($coll_asst != $result[$ctr]['coll_asst'] and $ctr !=0 ) { ?>

    <tr  style="white-space:nowrap">  

        <td colspan="16"  style="text-align: center;"><?php echo $result[$ctr]['coll_asst'] ?>&nbsp;</td> 
...
<tr style="white-space:nowrap">
    ...
    <?php if($coll_asst != $result[$ctr]['coll_asst'] and $ctr !=0 ) { ?>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><?php echo $result[$ctr]['coll_asst'] ?> - SUB TOTAL&nbsp;</td>
    ...
    <?php $coll_asst = $result[$ctr]['coll_asst'] ; ?>   
