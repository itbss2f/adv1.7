...
<tr style="white-space:nowrap">
        ...
        <th style="width:110px;">30 Days</th>
        <th style="width:110px;">60 Days</th>
        <th style="width:110px;">90 Days</th>
        <th style="width:110px;">120 Days</th>
        <th style="width:110px;">150 Days</th>
        <th style="width:110px;">180 Days</th>
        <th style="width:110px;">210 Days</th>
...
<?php if($agency_name != $result[$ctr]['agency_name'] and $ctr !=0 ) { ?>
    ...
    <tr style="font-size: 10px;">  
        ...
        <td colspan="11"  style="text-align: center;"><?php echo $result[$ctr]['agency_name'] ?>&nbsp;</td> 
