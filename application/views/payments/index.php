	...
	<div class="row-fluid">
		...
		<div class="span8">
			...
			<div class="block-fluid">  				
				...
				<div class="row-form-booking">     
                    ...
                    <div class="span2"><input type="text" id="orno" name="orno" style="text-align:right"/></div>                               
					<div class="span1" style="width:45px">OR Date</div>			
					<div class="span2"><input type="text" id="ordate" name="ordate" value="<?php echo Date('Y-m-d'); ?>" readonly='readonly'/></div>	
		...
		<div class="span4">		
			...
			<div class="row-form-booking">
				...
				<div class="span3"><input type="text" id="evatamount" name="evatamount" class="radio_evat" readonly="readonly" value="0.00" style="text-align:right"/></div>	
				<div class="span2"><input type="text" id="evatpercent" name="evatpercent" class="radio_evat" readonly="readonly" value="0.00" style="text-align:right"/></div>
				<div class="clear"></div>				               					
			</div>
			<div class="row-form-booking">
