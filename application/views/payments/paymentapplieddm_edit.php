<div class="block-fluid">                  
       <div class="row-form-booking">   
        ...
        <div class="span1" style="width:80px"><input type="text" value="<?php echo $data['ao_num'] ?>" readonly="readonly"></div>
    ...
    <div class="row-form-booking">        
        ...
        <div class="span1" style="width:80px"><input type="text" style="text-align:right" value="<?php echo number_format(@$data['amountdue'], 2, '.', ','); ?>" readonly="readonly"></div>
        <div class="clear"></div>    
    </div>
    <div class="row-form-booking">
    ...
    <div class="row-form-booking">    
        <div class="span1" style="width:180px"><button class="btn btn-block btn-danger" type="button" id="btn_removeapplied2" name="btn_removeapplied2">Remove Applied</button></div>        
...
$("#btn_removeapplied2").click(function() {
    var $id = "<?php echo $id ?>";    
    var $confirm = confirm("Are you sure you want to remove this applied or payment?");

    if ($confirm) {
        $.ajax({
            url: "<?php echo site_url('payment/removeTempORPaymentApplied') ?>",
            type: "post",
            data: {id: $id,
            ...
            success:function(response) {
                $response = $.parseJSON(response); 
                $('#updatepaymentapplieddm_view').dialog('close');  
...
$("#btn_updateapplied").click(function(){
    ...
    if (countValidate == 0) {
        ...
        $.ajax({
            url: "<?php echo site_url('payment/updateTempORPaymentApplied') ?>",
            type: "post",
            data: {
                 id: "<?php echo $id ?>",
                 mykeyid: "<?php echo $mykeyid ?>",
