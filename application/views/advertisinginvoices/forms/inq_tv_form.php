...
<thead>
 ...
 <tr style="text-align: center;">
        ...
        <th style="width:150px"><b>Issue Dat</b>e</th>
        <th style="width:150px"><b>Particulars</b></th> 
        <th style="width:150px"><b>Spot</b></th> 
        <th style="width:150px"><b>Rate</b></th> 
        <th style="width:150px"><b>Total Amount</b></th> 
...
<tbody>
     ...
     <?php for($ctr=0;$ctr<count($result);$ctr++)  { ?>   
        <tr>
            ...
            <td><?php echo number_format($result[$ctr]['rate_c'],2,'.',',') ?></td>
            <td><?php echo number_format($result[$ctr]['total_bill_detail'],2,'.',',') ?></td>
        </tr>
    <?php } ?>
    <?php } else { ?>
