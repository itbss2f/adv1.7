<div class="block-fluid">    
	<form action="<?php echo site_url('yms_rates/update/'.$data['id']) ?>" method="post" name="formsave" id="formsave"> 
	...
	<div class="row-form-booking">
		...
		<div class="span1" style="width:80px"><input type="text" placeholder="From" name="periodcoveredfrom" value="<?php echo $data['period_covered_from']?>" id="periodcoveredfrom"></div>		
		<div class="span1" style="width:80px"><input type="text" placeholder="To" name="periodcoveredto" value="<?php echo $data['period_covered_to']?>" id="periodcoveredto"></div>		
		<div class="clear"></div>	
	</div>
	<div class="row-form-booking">
