<div class="block-fluid">      
    <form action="<?php echo site_url('module/save') ?>" method="post" name="formsave" id="formsave"> 
    ...
    <div class="row-form-booking">
        ...
        <div class="span2" style="width:190px"><input type="text" name="segment" id="segment"></div>  
        <div class="clear"></div>    
    </div>
    <div class="row-form-booking">
