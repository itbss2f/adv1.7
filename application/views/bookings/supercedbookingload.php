	...
	<div class="span8">
		<div class="head">
		    ...
		    <ul class="buttons">			   
                ...
                <?php if($canBOOKINGUPDATE && ($data['status'] != "C" && $data['status'] != "P" && $data['status'] != "O")) : ?>    
                <li><a href="#" class="isw-archive" id="action_savebookingsuperced" title="Save to update this Booking"></a></li>
               <?php endif; ?>
                ...
                <?php if($canBOOKINGKILLED && ($data['status'] != "C" && $data['status'] != "P" && $data['status'] != "O") && $invoiceTransac <= 0 && $paginatedTransac <= 0) : ?>                                                     
                <li><a href="#" class="isw-cancel" id="action_supercedkillbooking" title="Kill Booking"></a></li>                  
                <?php endif; ?> 
...
<form action="<?php echo site_url('booking/saveupdateSupercedingBooking/'.$data['ao_num']) ?>" method="post" name="form_saveBooking" id="form_saveBooking">
		<div class="block-fluid">   
			...
			<div class="row-form-booking">
			   ...
			   <div class="span5"><input type="text" id="payee" name="payee" value="<?php echo str_replace('\\','',$data['ao_payee']) ?>"/></div>
			   <div class="clear"></div>				
		     </div>
			<div class="row-form-booking">
			...
			<div class="row-form-booking">
               ...
               <div class="span2"><input type="text" id="tin" name="tin" value="<?php echo $data['ao_tin'] ?>"/></div>     
			   <div class="clear"></div>
			</div>  	   

			<div class="row-form-booking" style="height:10px">				 				   
			   <div class="clear"></div>			
			</div>                                                                                                                                       
			<div class="row-form-booking" style="display:none">	
...
<div class="span5" style="height:40px">
