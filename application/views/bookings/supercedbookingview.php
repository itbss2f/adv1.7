...
<form action="<?php echo site_url('booking/saveupdateSupercedingBooking/') ?>" method="post" name="form_saveBooking" id="form_saveBooking">
		<div class="block-fluid">   
			...
			<div class="row-form-booking">
			   ...
			   <div class="span2" style="border-left:1px solid #DDDDDD;"><strong>Invoice Number:</strong></div>					
			   <div class="span2"><span class="label label-info" style="color:#FFFFFF"><strong><?php echo "asd" ?></span></strong></div>
			   <div class="clear"></div>				
		     </div>
			<div class="row-form-booking">
			...
			<div class="row-form-booking">
			   ...
			   <div class="span4"><input type="text" id="refno" name="refno" value="<?php echo $data['ao_ref'] ?>"/></div> 
