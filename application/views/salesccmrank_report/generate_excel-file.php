<tr>
        ...
        <b><td style= "text-align: left; font-size: 20">SALES CCM RANK  - <b><?php echo $reportname ?></b></td><br/>
...
<td colspan = "14" style="font-size: 12px; color: black"></td> 
  ...
  <tr>
        ...
        <?php 
                ...
                ?>
                       <tr>
                           <td style="text-align: left"><?php echo $row['particulars'] ?></td>
                            ...
                            <td><b><?php echo number_format($row['totalamt'], 2, '.',',')?></b></td>
                       </tr>
            ...
            ?>
            <tr>
    <b><td style="text-align: right;background: #C0C0C0; font-size: 14px; color: red"><b>GRANDTOTAL:</td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tjan, 2, '.',',') ?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tfeb, 2, '.',',') ?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tmar, 2, '.',',') ?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tapr, 2, '.',',') ?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tmay, 2, '.',',') ?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tjune, 2, '.',',')?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tjuly, 2, '.',',')?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($taug, 2, '.',',') ?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tsep, 2, '.',',') ?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($toct, 2, '.',',') ?></td>
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tnov, 2, '.',',') ?></td>                                    
    <td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($tdec, 2, '.',',') ?></td>
    <b><td style="background: #C0C0C0; font-size: 14px; color: red"><b><?php echo number_format($totalamt, 2, '.',',') ?></td>
        ...
        // Adtype | Product
            ...
            foreach ($dlist as $adtype => $datalist) { 
               ...
               <tr>
                    ...
                    <b><td style="text-align: left"><?php echo $row['particulars'] ?></td>
                    <td><?php echo number_format ($jan, 2, '.',',') ?></td>
                    <td><?php echo number_format ($feb, 2, '.',',') ?></td>
                    <td><?php echo number_format ($mar, 2, '.',',') ?></td>
                    <td><?php echo number_format ($apr, 2, '.',',') ?></td>
 ...
 <b> <td style="text-align: right;background: #C0C0C0; font-size: 14px; color: red; font-weight: 300"><b>SUBTOTAL:</b></td>
  ...
  <><td style="background: #C0C0C0; font-size: 14px; color: red"><?php echo number_format($totalamt, 2, '.',',') ?></td>
