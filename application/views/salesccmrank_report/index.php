    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="head">
                <div class="isw-grid"></div>
                    <h1>Sales CCM Ranking Report</h1>
                    <ul class="buttons">
        ...
        <div class="block-fluid">                        
            <div class="row-form" style="padding: 2px 2px 2px 10px;">
                ...
                <div class="span2" style="width:70px;margin-top:12px">Pay Type</div>
                <div class="span2" style="width:100px;margin-top:12px">
...
$("#generatereport").click(function(response) {
    ...
    var countValidate = 0;  
    var validate_fields = ['#datefrom', '#dateto', '#toprank'];
    ...
    $("#source").attr('src', "<?php echo site_url('salesccmrank_report/generatereport') ?>/"+datefrom+"/"+dateto+"/"+reporttype+"/"+bookingtype+"/"+toprank+"/"+adtypefrom+"/"+adtypeto+"/"+productfrom+"/"+productto+"/"+branchfrom+"/"+branchto+"/"+toprank+"/"+paytype);     
...
$("#exportreport").die().live("click",function() {
    ...
    for (x = 0; x < validate_fields.length; x++) {            
       ...
       {
    window.open("<?php echo site_url('salesccmrank_report/exportreport/') ?>?datefrom="+datefrom+"&dateto="+dateto+"&bookingtype="+bookingtype+"&reporttype="+reporttype+"&toprank="+toprank+"&adtypefrom="+adtypefrom+"&adtypeto="+adtypeto+"&productfrom="+productfrom+"&productto="+productto+"&branchfrom="+branchfrom+"&branchto="+branchto+"&toprank="+toprank+"&paytype="+paytype, '_blank');
            window.focus();     
