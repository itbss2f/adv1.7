 ...
 <div class="workplace">
    ...
    <div class="row-fluid">
        ...
        <form id="report_form" action="<?php echo site_url("classifiedreport/generate_report") ?>" method="POST">       
...
$report_type = $("#report_type").die().live('change',function()
{
    ...
    $.ajax({
        url:"<?php echo site_url("classifiedreport/selectfilter") ?>",
        type:"post",
...
{ 
    ...
    switch($report_type)
    {
        ...
        case "adlist_branch":
               ...
               validate_fields.push("#from_branch","#to_branch","#from_product","#to_product");
               
        break;
        
        case "adlist_ca":
        
               validate_fields.push("#from_product","#to_product");
 ...
 function submitform()
 {
     ...
     xhr =  $.ajax({
          url:"<?php echo site_url('classifiedreport/generate') ?>",
          type:"POST",
