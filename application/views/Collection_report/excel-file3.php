...
<tr>
    <td style="text-align: left; font-size: 20">COLLECTION REPORT - CASHIER / COLLECTOR</td> <br>
</tr>
<tr>  
                    ...
                    <?php
                       ...
                       ?>
                        ...
                        <tr>
                            ...
                            <td style ="text-align: left;"><?php echo $row['collarea_code'] ?></td>
                            <td style ="text-align: left;"><?php echo $row['collarea_name'] ?></td>
