...
<tr>
    <td style="text-align: left; font-size: 20">COLLECTION REPORT - COLLECTION AREA </td> <br>
</tr>
<tr>
    <td style="text-align: left; font-size: 20">DATE FROM: <?php echo date("F d, Y", strtotime($datefrom)).' TO '. date("F d, Y", strtotime($dateto)); ?></td> <br>
        ...
        <?php
            ...
            foreach ($data as $part => $data) {   ?>
                      ...
                      <tr>
                        <td colspan = "17" style= "color: black;"><b><?php echo  utf8_decode($part) ?></b></td>
                    </tr>
            ...
            <?php
               /* $result[] = array(array('text' => utf8_decode($part), 'align' => 'left', 'bold' => true, 'size' => 12));  */
                foreach ($data as $adtype => $data) {   ?>
                       ...
                       <tr>
                        <td colspan = "17" style= "color: black;"><b><?php echo $adtype ?></b></td>
                    </tr>
                    ...
                    <?php
                       ...
                       ?>
                        ...
                        <tr>
                            ...
                            <td style ="text-align: left;"><?php echo $row['collector'] ?></td>
