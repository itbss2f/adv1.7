...
<tr>
    <td style="text-align: left; font-size: 20">COLLECTION REPORT - ALL NON-AGENCY SUMMARY</td> <br>
</tr>
<tr>  
                    ...
                    <?php
                       ...
                       ?>
                        ...
                        <tr>
                            ...
                            <td style ="text-align: left;"><?php echo $row['yer'] ?></td>
                            <td style ="text-align: left;"><?php echo $row['mon'] ?></td>
                            <td style ="text-align: left;"><?php echo $row['invnum'] ?></td>
                            <td style ="text-align: left;"><?php echo $row['invdate'] ?></td>
                            <td style ="text-align: left;"><?php echo $row['collasstname'] ?></td> 
