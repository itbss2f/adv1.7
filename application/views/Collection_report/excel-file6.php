...
<tr>
    <td style="text-align: left; font-size: 20">COLLECTION REPORT - YEARLY BREAKDOWN </td> <br>
</tr>
<tr>  
    <td style="text-align: left; font-size: 20">DATE FROM : <?php echo date("F d, Y", strtotime($datefrom)).' TO '. date("F d, Y", strtotime($dateto)); ?></td> <br> 
         ...
         <?php    
            ...
            if ($rettype == 1 || $rettype == 3) {
                foreach ($data as $agency => $rowdata) {  ?>
                 ...
                 <?php   
                    ...
                    <?php 
                        ...
                        <tr>
                            <td align="left"><?php echo $row['clientname'] ?></td>
                            ...
                            <td align="right"><?php  echo $row['totaljamt'] ?></td>
            ...
            <?php 
                foreach ($data as $row) {
                        ...
                        $totalj += $row['totalj']; $totalk += $row['totalk']; $totalw += $row['total']; ?>
                         ...
                         <tr>
                            <td align="right"><b><?php echo  $row['clientname'] ?></b></td>
                    ...
                    <tr>
                        ...
                        <td align="right"><?php echo  number_format($totalw, 2, '.', ',') ?></td>
                    </tr>
