    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="row-form" style="padding: 2px 2px 2px 10px;">
                ...
                <div class="span1" style="width: 80px; margin-top:12px"><input type="text" id="aonum" placeholder="Enter AO #" name="aonum"/></div> 
            ...
            <div class="row-form-booking-form">
                ...
                <div style="margin-top: 10px;width:40%;float:left">
                    <div class="row-form-booking-form">
                        ...
                        <div class="span8 span_limit" style="min-height: 10px;" id="clientname"></div>
                        <div class="clear"></div>
                    </div> 
                </div>
                <div style="margin-top: 10px;width:40%;float:left">
                    <div class="row-form-booking-form">
                        ...
                        <div class="span8 span_limit" style="min-height: 10px;" id="agencyname"></div>
                        <div class="clear"></div>
                    </div> 
                </div>            
                <div style="margin-top: 10px;width:40%;float:left">
                    <div class="row-form-booking-form">
                        ...
                        <div class="span8 span_limit" style="min-height: 10px;" id="adtype"></div> 
                        <div class="clear"></div>
                    </div> 
                </div>
                <div style="margin-top: 10px;width:40%;float:left">
                ...
                <div style="margin-top: 10px;width:40%;float:left">
                    <div class="row-form-booking-form">
                        ...
                        <div class="span8 span_limit" style="min-height: 10px;" id="paytype"></div>
                        <div class="clear"></div>
                    </div>
