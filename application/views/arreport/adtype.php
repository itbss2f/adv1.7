...
<?php foreach ($rowdata as $adtype => $rowdata2) : ?>
    <tr>
        <td width="177" align="left" style="font-size:35px;"><b><?php echo strtoupper($adtype) ?></b></td>   
    </tr>
    <?php foreach ($rowdata2 as $agency => $clientdata) : ?>    
        <tr>
            <td width="177" align="left" style="text-indent: 5px"><b><?php if ($agency != ' - ') { echo substr($agency, 0, 33); } ?></b></td>   
