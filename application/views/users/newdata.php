...
<div class="block-fluid">      
    ...
    <div class="row-form-booking">
        ...
        <div class="span2" style="width:190px"><input type="text" name="expirydate" id="expirydate" value="<?php echo Date('Y-m-d', strtotime("+90 days "))?>"></div>        
        <div class="clear"></div>    
    </div>
	<div class="row-form-booking">
        ...
        if (pass1 != pass2) {
            ...
            if (pass_str != 'strong') {
                ...
                $.ajax({
                    ...
                    type: "post",
                    data: {username: $("#username").val(), empno: $("#empno").val()},
