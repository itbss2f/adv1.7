...
<div class="block-fluid">      
    ...
    <div class="row-form-booking">
        ...
        <div class="span2" style="width:190px"><input type="text" name="username" id="username" value="<?php echo $data['username'] ?>"></div>        
        <div class="clear"></div>    
    </div>
    ...
    <div class="row-form-booking">
        ...
        <div class="span1" style="width:190px">
            <select name="userstat" id="userstat">
                <?php foreach ($userstat as $row) : ?>
                <?php if ($row['id'] == $data['expire']) : ?>
...
$("#save").click(function() {
    var countValidate = 0;  
    var validate_fields = ['#empno', '#firstname', '#middlename', '#lastname', '#userlevel', '#branch', '#department', '#position', '#emailadd', '#username', '#expirydate','#userstat'];
