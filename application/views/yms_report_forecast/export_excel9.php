...
<tr>
    <td style="text-align: left; font-size: 20">FORECAST DAILY AD SUMMARY REPORT (Classification Summary) </td> <br>
</tr>
<tr>  
               ...
               <?php         $result[] = array(array("text" => $x, "bold" => true, "align" => "left", "size" => "11"));  ?>
                  ...
                  <?php
                    ...
                    <tr>
                        ...
                        <td style="color:black ; text-align: center;"><?php echo $row["class_code"] ?></td>
                        <td style="color:black ; text-align: center;"><?php echo $row["class_codepage"] ?></td>
                    </tr>
                            ...
                            <?php       $result[] = array(
                                                    ...
                                                    array("text" =>$row["class_code"]), 
                                                    array("text" =>$row["class_codepage"]));
                        }
                        ?>
