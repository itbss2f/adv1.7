                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="hidden" name="aeid" id="aeid" value="<?php echo $this->session->userdata('authsess')->sess_id ?>">    <input type="text" id="datefrom" placeholder="FROM" name="datefrom" value="<?php echo $datefrom ?>" class="datepicker"/>&nbsp;&nbsp;<input type="text" id="dateto" placeholder="TO" value="<?php echo $dateto ?>" name="dateto" class="datepicker"/></td>
                        </tr> 
