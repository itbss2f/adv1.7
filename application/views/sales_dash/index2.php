                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Date From :</td>
                            <td><input type="text" id="datefrom" placeholder="FROM" name="datefrom" value="<?php echo $datefrom ?>" class="datepicker"/>&nbsp;&nbsp;<input type="text" id="dateto" placeholder="TO" value="<?php echo $dateto ?>" name="dateto" class="datepicker"/></td>
                        </tr> 
...
$("#filter").click(function(){
    ...
    $.ajax({
        ...
        type: 'post',
        data: {datefrom: datefrom, dateto: dateto, toprank: toprank, rettype: rettype, actual: actual},
 ...
 $("#exceltopclient").die().live("click",function() {
    ...
    window.open("<?php echo site_url('sales_dash/exceltopclient') ?>?reporttype="+reporttype+"&datefrom="+datefrom+"&dateto="+dateto+"&toprank="+toprank, '_blank'); 
    window.focus();
  ...
  $("#exceltopagency").die().live("click",function() {
    ...
    window.open("<?php echo site_url('sales_dash/exceltopagency') ?>?reporttype="+reporttype+"&datefrom="+datefrom+"&dateto="+dateto+"&toprank="+toprank, '_blank'); 
    window.focus();
       });
    ...
    window.open("<?php echo site_url('sales_dash/exceltopdirect') ?>?reporttype="+reporttype+"&datefrom="+datefrom+"&dateto="+dateto+"&toprank="+toprank, '_blank'); 
    window.focus();   
   ...
   $("#exceltopadtype").die().live("click",function() {
    ...
    window.open("<?php echo site_url('sales_dash/exceltopadtype') ?>?reporttype="+reporttype+"&datefrom="+datefrom+"&dateto="+dateto+"&toprank="+toprank, '_blank'); 
    window.focus();   
