	...
	<div class="row-fluid">
		...
		<div class="block-fluid">                        
			<div class="row-form" style="padding: 2px 2px 2px 10px;">
				...
				<div class="span1" style="width:50px;margin-top:12px">Type</div>
				<div class="span2" style="margin-top:12px">
					<select>
						<option value="A"> Agency </option>
						<option value="D"> Direct Ads </option>
					</select>
				</div>
...
$("#generatereport").click(function(){
	...
	if (countValidate == 0) {
		$(".c_loader").show();
		$.ajax({
			url: "<?php echo site_url('ar_aging_ad/generatereport') ?>",
			type: "post",
			data: {},
			success:function(response) {
					$("#source").attr('src', 'http://localhost/ies_beta/ar_aging_ad/generatereport');
					$(".c_loader").hide();
			}
		});		
	} else {			
