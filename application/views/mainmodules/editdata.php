<div class="block-fluid">      
    <form action="<?php echo site_url('mainmodule/update/'.$data['id']) ?>" method="post" name="formsave" id="formsave"> 
    <div class="row-form-booking">
        <div class="span2" style="width:120px"><b>Main Module</b></div>    
        <div class="span2" style="width:190px"><input type="text" name="mainmodulename" id="mainmodulename" value="<?php echo $data['name'] ?>"></div>        
        <div class="clear"></div>    
    </div>
    <div class="row-form-booking">
    ...
    <div class="row-form-booking">
        ...
        <div class="span2" style="width:100px"><input type="text" name="order" id="order" value="<?php echo $data['order'] ?>"></div>  
        <div class="clear"></div>    
    </div>
    <div class="row-form-booking">
        <div class="span2" style="width:120px"><b>Icon</b></div>    
        <div class="span2" style="width:190px"><input type="text" name="icon" id="icon" value="<?php echo $data['icon'] ?>"></div>  
        <div class="clear"></div>    
    </div>
    <div class="row-form-booking">
