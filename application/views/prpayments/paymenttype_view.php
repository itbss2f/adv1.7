<div class="block-fluid">       
	...
	<div class="row-form-booking-hidden" id="display_checkdate" style="display:none">
		...
		<div class="span2"><input type="text" id="check_date" name="check_date"/></div>
		<div class="clear"></div>	
	</div>
...
$("#btn_addpayment").click(function(){
	...
	if (countValidate == 0) {
		...
		$.ajax({
			url: "<?php echo site_url('prpayment/saveTempPRPayment') ?>",
			type: "post",
			data: {
...
$("#payment_type").change(function(){
	...
	$("#remarks").val("");
	if ($payment_type == "CK") {
        $("#check_date").datepicker({dateFormat: 'yy-mm-dd', minDate: $prdate, maxDate: '2Y' });   
		$("#display_bank").show();	
		$("#display_branch").show();	
