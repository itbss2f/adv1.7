...
<form action="<?php echo site_url('prpayment/savePRPayment') ?>" method="post" name="form_savePrPayment" id="form_savePrPayment">
<div class="workplace">
	<div class="row-fluid">
		...
		<div class="span8">
			<div class="head">
			    ...
			    <ul class="buttons">		
                    <?php if ($canADD) : ?>		  
				    <li><a href="#" class="isw-archive" id="prsave" name="prsave"></a></li> 	
                    <?php endif; ?>
			...
			<div class="block-fluid">  				
				...
				<div class="row-form-booking">
					...
					<div class="span2"><input type="text" id="prno" name="prno" style="text-align:right"/></div>                 
					<div class="span1" style="width:45px;">PR Date</div>			
					<div class="span2"><input type="text" id="prdate" name="prdate" value="<?php echo Date('Y-m-d'); ?>"/></div>	
				...
				<div class="row-form-booking">
					...
					<div class="span2"><input type="text" id="ordate" name="ordate" readonly="readonly"/></div>
				...
				<div class="row-form-booking">
					<div class="span1"><input type="radio" name="prchoose" id="prchoose" value="1" style="width:10px;">A</div>
					<div class="span1"><input type="radio" name="prchoose" id="prchoose" value="2" checked="checked" style="width:10px;">C</div>																
				...
				<div class="row-form-booking">
					...
					<div class="span2"><input type="text" id="amountpaid" name="amountpaid" style="text-align:right;" value="0.00" readonly="readonly"/></div>					               
					<div class="span2">Assigned Amount</div>			
					<div class="span2"><input type="text" id="assignedamount" name="assignedamount" style="text-align:right;" value="0.00" readonly="readonly"/></div>
					<div class="span2" style="width:70px">Notarial Fee</div>			
					<div class="span1" style="width:70px"><input type="text" id="notarialfee" name="notarialfee" value="0.00" style="text-align:right;"/></div>
					<div class="clear"></div>
				</div>
				<div class="row-form-booking">
