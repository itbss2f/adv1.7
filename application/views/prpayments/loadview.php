...
<form action="<?php echo site_url('prpayment/saveupdatePRPayment/'.$data['pr_num']) ?>" method="post" name="form_savePrPayment" id="form_savePrPayment">
<div class="workplace">
	<?php 
	...
	<div class="row-fluid">
		...
		<div class="span8">
			<div class="head">
			    ...
			    <h1 style="font-size:14px">Provisional Reciept</h1>
			    <ul class="buttons">				  
					<?php if(empty($data['pr_ornum']) && $canEDIT) : ?>	
					<li><a href="#" class="isw-archive" id="prsaveupdate" name="prsaveupdate" title="Save update PR Payment"></a></li> 
					<?php endif; ?>
					<li><a href="#" class="isw-refresh" id="action_newprpayment" title="New PR Payment"></a></li> 	
					<?php if ($canDELETEPR && (empty($data['pr_ornum']))) :  ?>        
					<li><a href="#" class="isw-minus" id="prdelete" name="prdelete" title="Delete PR Payment"></a></li> 
					<?php endif; ?>   
					<?php if ($canCANCELLEDPR && (empty($data['pr_ornum'])) && $data['status'] != 'C') :  ?> 
					<li><a href="#" class="isw-cancel" id="prcancelled" name="prcancelled" title="Cancelled PR Payment"></a></li> 
			 		<?php endif; ?> 
             		<li><a href="#" class="isw-zoom" id="prlookup" name="prlookup"></a></li> 
		         </ul>       
			    <div class="clear"></div>
			</div>
			<div class="block-fluid">  				
				...
				<div class="row-form-booking">
					...
					<div class="span2"><input type="text" id="prno" name="prno" value="<?php echo $data['pr_num'] ?>" style="text-align:right" readonly="readonly"/></div>                 
					<div class="span1" style="width:45px;">PR Date</div>			
					<div class="span2"><input type="text" id="prdate" name="prdate" value="<?php echo date('Y-m-d', strtotime($data['pr_date'])); ?>" readonly="readonly"/></div>	
					<div class="span1" style="width:30px">Type</div>			
					<div class="span2">
						<select style='width:180px;' class='select' name='prtype' id='prtype'>
				...
				<div class="row-form-booking">
					...
					<div class="span2"><input type="text" id="orno" name="orno" value="<?php echo $data['pr_ornum'] ?>" style="text-align:right" readonly="readonly"/></div>                 
					<div class="span1" style="width:45px">OR Date</div>			
					<div class="span2"><input type="text" id="ordate" name="ordate" value="<?php echo $data['pr_ordate'] ?>" readonly="readonly"/></div>	
					<?php if(!empty($data['pr_ornum'])) : ?>						
					<div class="span4"><a href="#" id=""><span class="label label-important" style="color:#FFFFFF;">CANNOT UPDATE ALREADY IMPORTED TO OR</span></a></div>
					<?php else: ?>
					<div class="span4"><span class="label label-info" style="color:#FFFFFF;">OFFICIAL RECIEPT INFORMATION</span></div>	
					<?php endif; ?>
				...
				<div class="row-form-booking">
					...
					<div class="span6"><input type="text" id="payeename" name="payeename" value="<?php echo str_replace('\\','',$data['pr_payee']) ?>" placeholder="Name"/></div>
					<div class="clear"></div>
				</div>
				<div class="row-form-booking">
					<div class="span1">Address</div>			
					<div class="span4"><input type="text" id="address1" name="address1" value="<?php echo str_replace('\\','',$data['pr_add1']) ?>"/></div>					               
				...
				<div class="row-form-booking">
					<div class="span1"></div>			
					<div class="span4"><input type="text" id="address2" name="address2" value="<?php echo str_replace('\\','',$data['pr_add2']) ?>"/></div>					               	
				...
				<div class="row-form-booking">
					<div class="span1"></div>			
					<div class="span4"><input type="text" id="address3" name="address3" value="<?php echo str_replace('\\','',$data['pr_add3']) ?>"/></div>					               	
				...
				<div class="row-form-booking">
					...
					<div class="span2"><input type="text" id="assignedamount" name="assignedamount" value="<?php echo number_format($data['pr_assignamt'], 2, '.', ',') ?>" style="text-align:right;" value="0.00" readonly="readonly"/></div>
		...
		<div class="span4">		
			...
			<div class="row-form-booking">
				...
				<div class="span3"><input type="text" id="wtaxamount" name="wtaxamount" class="radio_wtax" value="<?php echo number_format($data['pr_wtaxamt'], 2, '.', ',') ?>" <?php if ($data['pr_wtaxstatus'] != 1) { echo "readonly='readonly'";} ?> style="text-align:right"/></div>	
				<div class="span2"><input type="text" id="wtaxpercent" name="wtaxpercent" class="radio_wtax" value="<?php echo number_format($data['pr_wtaxpercent'], 2, '.', ',') ?>" <?php if ($data['pr_wtaxstatus'] != 1) { echo "readonly='readonly'";} ?> style="text-align:right"/></div>
				<div class="span3"><input type="text" id="wtaxassign" name="wtaxassign" value="<?php echo number_format($data['pr_assignwtaxamt'], 2, '.', ',') ?>" readonly="readonly" style="text-align:right"/></div>
				<div class="clear"></div>				               					
			</div>	
			<div class="row-form-booking">
				...
				<div class="span3"><input type="text" id="wvatamount" name="wvatamount" class="radio_wvat" value="<?php echo number_format($data['pr_wvatamt'], 2, '.', ',') ?>" <?php if ($data['pr_wvatstatus'] != 1) { echo "readonly='readonly'";} ?> style="text-align:right"></div>	
				<div class="span2"><input type="text" id="wvatpercent" name="wvatpercent" class="radio_wvat" value="<?php echo number_format($data['pr_wvatpercent'], 2, '.', ',') ?>" <?php if ($data['pr_wvatstatus'] != 1) { echo "readonly='readonly'";} ?> style="text-align:right"></div>
				<div class="span3"><input type="text" id="wvatassign" name="wvatassign" value="<?php echo number_format($data['pr_assignwvatamt'], 2, '.', ',') ?>" readonly="readonly" style="text-align:right"/></div>
				<div class="clear"></div>				               					
			</div>				
			<div class="row-form-booking">
				...
				<div class="span3"><input type="text" id="ppdamount" name="ppdamount" class="radio_ppd" value="<?php echo number_format($data['pr_ppdamt'], 2, '.', ',') ?>" <?php if ($data['pr_ppdstatus'] != 1) { echo "readonly='readonly'";} ?>" style="text-align:right"/></div>	
				<div class="span2"><input type="text" id="ppdpercent" name="ppdpercent" class="radio_ppd" value="<?php echo number_format($data['pr_ppdpercent'], 2, '.', ',') ?>" <?php if ($data['pr_ppdstatus'] != 1) { echo "readonly='readonly'";} ?> style="text-align:right"/></div>
				<div class="span3"><input type="text" id="ppdassign" name="ppdassign" value="<?php echo number_format($data['pr_assignppdamt'], 2, '.', ',') ?>" readonly="readonly" style="text-align:right"/></div>
				<div class="clear"></div>				               					
			</div>
			<div class="head" style="border:2px solid #335A85;height:20px">						   
			   	<span style="color:#fff"><strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong></span>
