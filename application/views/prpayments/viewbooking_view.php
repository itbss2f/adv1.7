...
$("#load_booking").click(function() {
    ...
    if(typeof loadid != 'undefined') {
        $.ajax({
            url: "<?php echo site_url('prpayment/loaddefaultdata'); ?>",
            type: "post",
            data: {id: loadid},
            success: function(response) {
                ...
                $("#particulars").val($response['data']['part']);
...
$("#search_booking").click(function(){
    $.ajax({
        url: "<?php echo site_url('prpayment/viewbooking_list') ?>",
        type: 'post',
        data: {
            aono: $('#b_aono').val(),
