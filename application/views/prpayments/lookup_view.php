...
<div class="row-form-booking">                            
	<div class="span2" style="padding-left:50px">
	  <button class="btn btn-block" type="button" id="lookup_search_btn" name="lookup_search_btn">Search PR</button>
	</div>
	<div class="span2">
	  <button class="btn btn-block" type="button" id="lookup_loaddetailed" name="lookup_loaddetailed">Load PR</button>
	</div>		                   
	<div class="clear"></div>
</div>  
<div class="dr" style="margin-top:-10px"><span></span></div>
...
$("#lookup_loaddetailed").click(function() {
	...
	if(typeof prnum != 'undefined') {
		window.location.href = "<?php echo base_url()?>prpayment/load_prpayment/"+prnum;
...
$("#lookup_search_btn").click(function() {
	...
	var $prcheckno = $('#lookup_checknumber').val();	

	$.ajax({
		url: "<?php echo site_url('prpayment/prlookup')?>",
		type: 'post',
