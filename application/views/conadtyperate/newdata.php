<div class="block-fluid">      
    <form action="<?php echo site_url('conadtyperate/save') ?>" method="post" name="formsave" id="formsave"> 
    ...
    <div class="row-form-booking">
        <div class="span2" style="width:120px"><b>Rate Code</b></div>    
        <div class="span2" style="width:100px;"><input type="text" name="rate_code" id="rate_code"></div>        
        <div class="clear"></div>    
    </div>
    <div class="row-form-booking">
        <div class="span2" style="width:120px"><b>Rate Name</b></div>    
        <div class="span2" style="width:190px"><input type="text" name="rate_name" id="rate_name"></div>        
        <div class="clear"></div>    
    </div>
    <div class="row-form-booking">
    ...
    <div class="row-form-booking">
        <div class="span3"><button class="btn btn-success" type="button" name="save" id="save">Save Rate button</button></div>        
        <div class="clear"></div>        
    </div>
    </form>
</div>
