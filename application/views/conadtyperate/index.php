...
<div class="workplace">
    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            ...
            <?php foreach ( $rate as $type => $dataintype ) : ?>            
                <li class="closed">
                        ...
                        <?php foreach ( $data as $row ) : ?>
                            <li>
                                <div style="width: 250px; float: left;">
                                    <a href="#" class="edit" id="<?php echo $row['id'] ?>"><span class="file"><?php echo $row["adtyperate_name"] ?></span></a>                                
                                </div>
...
$(function() {
    ...
    $('.edit').click(function() {
        var $id = $(this).attr('id');
        $.ajax({
          url: "<?php echo site_url('conadtyperate/editdata') ?>",
          type: "post",
          data: {id: $id},
    ...
    $('#newdata').click(function(){        
       $.ajax({
          url: "<?php echo site_url('conadtyperate/newdata') ?>",
          type: "post",
          data: {},
          success:function(response) {
             $response = $.parseJSON(response);
