...
<tr>
    ...
    <br/><b><td style="text-align: left">PLOUGH BACK (ADVERTISING) - <b><td style="text-align: left"><?php echo $reportname ?><br/></b> 
...
<thead>
  <tr>
    ...
    <th width="5%">Total Gross Amount</th>      
    <th width="10%">15% A/C'</th>
    <th width="10%">Total Net Amount</th> 
    <th width="10%">OR Number</th>
    <th width="10%">OR Date</th>     
    <th width="10%">Amount Paid</th>     
    <th width="10%">No. of Past Due</th>     
    <th width="10%">Net DM/CM</th>     
