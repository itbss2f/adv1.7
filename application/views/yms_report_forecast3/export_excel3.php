...
<tr>
    ...
    <td style="text-align: left; font-size: 20">Actual Daily Ad Summary (Summary per Issue)</td><br>
        ...
        <?php                                                                        
                  ...
                  /*  $result[] = array(array("text" => "EDITION : ".$prod, "bold" => true, "size" => 9, "align" => "left")); */
                    ...
                    foreach ($datalist as $row)  {     ?>
                                ...
                                <tr>
                                    <td style="text-align: center;"><?php echo date("M d, Y", strtotime($row["issuedate"])) ?></td>
