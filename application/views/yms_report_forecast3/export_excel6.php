...
<tr>
    ...
    <td style="text-align: left; font-size: 20">Actual Contribution Margin with Target (Ads Summary)</td> <br>
    ...
    <td style="text-align: left; font-size: 20"><?php echo $paidname .' '.$excludename ?></td></b> 
</tr>
</thead>
    ...
    <table cellpadding = "0" cellspacing = "0" width="100%" border="1">
            ...
            <thead>
             <tr>
                ...
                <th width="13%">Print. Cost/Issue</th> 
                <th width="13%">Cont. Margin</th>    
                <th width="13%">Cont. Target</th>    
       ...
       <?php   
          ...
          foreach ($data as $data) :
                foreach ($data["page"] as $z => $xx) {   ?>
                         ...
                         <tr>
                            <td colspan = "9" style= "color: black"><b><?php echo $z ?></b></td>
                        </tr>
                    ...
                    <?php                        
                        ...
                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><?php echo $tcm_amount ?></td>
              ...
              <?php       /*   $result[] = array(array("text" => date("M d, Y", strtotime($zz))),                        
                    ...
                    ?>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;"><b><?php echo number_format($ttcm_amount ,2, ".", ",") ?></b></td>
                                    <td style="text-align: right;"><b><?php echo $tstrpercentage ?></b></td>
                                </tr>
                    
                  <?php /*   $result[] = array(array("text" => "TOTAL", "bold" => true),
