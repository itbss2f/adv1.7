...
<tr>
    ...
    <td style="text-align: left; font-size: 20">Actual Contribution Margin (%Ad Load/CM)</td> <br>
    ...
    <table cellpadding = "0" cellspacing = "0" width="100%" border="1">
            ...
            <thead>
             <tr>
                ...
                <th width="10%">Issue Dates</th> 
                <th width="10%">No. Pages</th> 
                <th width="10%">No. Ad Pages</th> 
                <th width="10%">Nc Pages</th> 
                <th width="10%">Peso Load</th>  
                <th width="13%">Peso Load vs Target</th>
                <th width="10%">Ad Load Ratio</th>
                <th width="10%">% CM</th>
                <th width="10%">CM VS Target</th>
            ...
            foreach ($data as $data) :     
                foreach ($data["page"] as $z => $xx) { ?>
                            ...
                            <tr>
                                <td colspan = "9" style= "color: black; text-align: left"><b><?php echo $z ?></b></td>
                            </tr>
                      ...
                      /* $result[] = array($x["book_name"], $x["pagetotal"], 
                        ...
                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><?php echo $xpages ?></b></td>
                                        <td style="text-align: right;"><?php echo number_format($xnopages ,2, ".", ",") ?></b></td>
                                        <td style="text-align: right;"><?php echo number_format($xcnoadpage,2, ".", ",") ?></b></td>
                                        <td style="text-align: right;"><?php echo number_format($pesoload,0, ".", ",") ?></b></td>
                                        <td style="text-align: right;"><?php echo $txpesovstartget ?></b></td>
                                        <td style="text-align: right;"><?php echo number_format($totaladloadratio , 2, ".", ",")." %" ?></b></td>
                                        <td style="text-align: right;"><?php echo $tstrpercentage ?></b></td>
                                        <td style="text-align: right;"><?php echo $tcmtarget ?></b></td>
                                    </tr>             
                  ...
                  <?php      
                    ...
                    ?> 
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;"><b><?php echo number_format($gtot_cnoadpage,2, ".", ",") ?></b></td>
