		...
		<div class="span12">
			<div class="head">
				<div class="isw-grid"></div>
					<h1>Yield Management System - Reports</h1>
					<ul class="buttons">
						<li>
							<a href="#" class="isw-settings"></a>
							<ul class="dd-list">
								<li><a href="#" id="newdata"><span class="isw-plus"></span> New YMS - Reports</a></li>                    					                  
							</ul>
						</li>	
					</ul>           			    
				<div class="clear"></div>
			...
			<thead>
				<tr>
					...
					<th width="60%">Report Description</th>
...
$(function() {
	...
	$('.edit').click(function() {
		var $id = $(this).attr('id');
		$.ajax({
		  url: "<?php echo site_url('yms_reports/editdata') ?>",
		  type: "post",
		  data: {id: $id},
	...
	$('.remove').click(function() {
		var $id = $(this).attr('id');
		var ans = confirm("Are you sure you want to remove this YMS reports?");	

		if (ans) {
			window.location = "<?php echo site_url('yms_reports/removeData') ?>/"+$id;
		}
	});

	$('#newdata').click(function(){        
	   $.ajax({
		  url: "<?php echo site_url('yms_reports/newdata') ?>",
		  type: "post",
		  data: {},
		  success:function(response) {
			 $response = $.parseJSON(response);
