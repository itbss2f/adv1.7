    ...
    <div class="row-fluid">
        ...
        <form id="report_form" action="<?php echo site_url("exdeal_report/generate_report") ?>" method="POST">       
              ...
              <div class="span2" id="section_select_dd"></div>
               ...
               <div class="span1"><b>From AE</b></div>
            
              <div class="span2"> 
                    
              <select name="from_ae" id="from_ae" style="width:150px">
                
                 <option value=""></option> 
                    
                      <?php for($ctr=0;$ctr<count($ae);$ctr++){ ?>
                        
                         <option value="<?php echo $ae[$ctr]['employee']  ?>"><?php echo $ae[$ctr]['employee']  ?></option>
               ...
               <div class="span1"><b>To AE</b></div>
            
              <div class="span2"> 
                    
              <select name="to_ae" id="to_ae" style="width:150px">
              ...
              <div class="span1">From Client</div>
              
              <div class="span2">
                    <select name="from_client" id="from_client" style="width:150px">
                    
                       <option value=""></option> 
                       
                       <?php for($ctr=0;$ctr<count($client);$ctr++){ ?>
                       
                         <option value="<?php echo $client[$ctr]['client_name']  ?>"><?php echo $client[$ctr]['client_name']  ?></option>
              ...
              <div class="span1">To Client</div>
              
              <div class="span2">
                    <select name="to_client" id="to_client" style="width:150px">
              ...
              <div class="span3" style="padding-top:10px;margin-left:0px;">
 ...
 $("#filter_btn").die().live("click",function(){
      ...
      xhr && xhr.abort(); 
           ...
           xhr = $.ajax({
               url:"<?php echo site_url("displaysupplement/filters"); ?>",
               type:"post",
               data:{},
 ...
 function submitform()
 {
     ...
     xhr =  $.ajax({
          url:"<?php echo site_url('displaysupplement/generateReport') ?>",
          type:"POST",
  ...
  $report_type = $("#report_type").die().live('change',function()
     {
        ...
        {
            $.ajax({
               url:'<?php echo site_url('displaysupplement/sectionlookup'); ?>',
               type:'post',
               //data:'',
               success: function(response)
               {
 ...
 function validate()
     {
            var validate_fields = ['#from_date', '#to_date',"#report_type","#from_client","#to_client","#from_ae","#to_ae"];      
