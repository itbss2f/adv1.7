<table>  
        ...
        <thead>
                   <tr>
                        ...
                        <th style='text-align:center;width:100px;'>Product Title</th>
                        
                        <th style='text-align:center;width:100px;'>Advertiser</th>
                        
                        <th style='text-align:center;width:100px;'>Agency</th>
...
<?php $book_name = ""; ?>
        ...
        <?php for($ctr = 0 ;$ctr<count($result);$ctr++) { ?>
                    ...
                    <?php if($result[$ctr]['dummy_section'] != $class_code and $ctr <= count($result) and $ctr != 0) { ?>
                    ...
                    <?php } ?>
                      ...
                      <?php  $class_code =   $result[$ctr]['dummy_section']; ?>
        <?php } ?>
