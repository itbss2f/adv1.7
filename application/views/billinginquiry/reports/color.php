              ...
              <?php if($switch == 1)
               ...
               <?php $color = $result[$ctr]["color_code"]; ?>
                                
               <?php if( $result[$ctr]["color_code"] != $section AND $ctr != 0) { ?>
               ...
               <?php $section = $result[$ctr]["color_code"];  ?> 


                <tr style="white-space: nowrap;" class="<?php echo $bg ?>">
                <td><?php  echo $result[$ctr]["sec"] ?></td>
              ...
              <tr style="background-color: gray;">
                    ...
                    <td colspan="8" style="text-align: right;"><b> SUBTOTAL - <?php echo $section  ?> </b></td>
                    <td style="text-align: right;"><b><?php echo number_format($sub_rate,2,'.',',') ?></b></td>
                    <td style="text-align: right;"><b><?php echo number_format($sub_prem,2,'.',',') ?></b></td>
                    <td style="text-align: right;"><b><?php echo number_format($sub_disc,2,'.',',') ?></b></td>
                    <td></td> 
