              ...
              <?php for($ctr=0;$ctr<count($result);$ctr++) { ?>  
               ...
               <?php if( ($result[$ctr]["sub_type"] != $section  OR $result[$ctr]['adtype_code'] != $adtype ) and $ctr != 0 ) { ?>      
                 
                <tr style="background-color: gray;">
                 
                    <td colspan="9" style="text-align: right;"><b>SUB TOTAL <?php echo $section." - ".$adtype ?></b></td>
               ...
               <?php } ?>  
                      ...
                      <?php $adtype  = $result[$ctr]["adtype_code"] ?>  
