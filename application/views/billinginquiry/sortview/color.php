...
<div class="block-fluid" style="height:600px;">
            ...
            <table class="fancyTable" id="myTable5" cellpadding="0" cellspacing="0">
                <thead>
              ...
              <?php for($ctr=0;$ctr<count($result);$ctr++) { ?>  
                ...
                <?php } ?>
                 ...
                 <?php if( $result[$ctr]["color"] != $section and $ctr != 0) { ?>
