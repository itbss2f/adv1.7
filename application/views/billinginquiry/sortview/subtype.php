...
<table  class="fancyTable" id="myTable4" cellpadding="0" cellspacing="0">
<thead>
                        <tr style="text-align: center;font-size:10px;white-space:nowrap;">
                             <?php for($ctr=0;$ctr<count($field_name_column_text);$ctr++) { ?>
                                ...
                                $width200 = array("Agency","Production Remarks","Remarks","Agency","Product Title","Po Number"); 
              ...
              <?php for($ctr=0;$ctr<count($result);$ctr++) { ?>  
                 ...
                 <?php } ?>
                   ...
                   <?php if( ($result[$ctr]["sub_type"] != $section  OR $result[$ctr]['ad_type'] != $adtype ) and $ctr != 0 ) { ?>
                              ...
                              <?php for($i=0;$i<count($field_name_column_sort);$i++) { ?> 
                                ...
                                <?php 
                                        ...
                                        switch($field_name_column_sort[$i])
                                        {
                                            ...
                                            <td style="text-align: right;"><b>[<?php echo $section." - ".$adtype ?>] <?php echo number_format($sub_rate,2,'.',',') ?></b></td>    
                                         ...
                                         <?php
                                          ...
                                          ?>  
                                            ...
                                            <td style="text-align: right;"><b>[<?php echo $section." - ".$adtype ?>]<?php echo number_format($sub_prem,2,'.',',') ?></b></td>    
                                          ...
                                          <?php 
                                            ...
                                            case "discount":
                                           ?>
                                             <td style="text-align: right;"><b>[<?php echo $section." - ".$adtype ?>] <?php echo number_format($sub_disc,2,'.',',') ?></b></td>    
                                          ...
                                          <?php     
                                            ...
                                            case "gross_amount":
                                          ?>
                                            <td style="text-align: right;"><b>[<?php echo $section." - ".$adtype ?>] <?php echo number_format($sub_amount,2,'.',',') ?></b></td>    
                                        ...
                                        <?php    
                                            ...
                                            case "ccm":
                                         ?>
                                            <td style="text-align: right;"><b>[<?php echo $section." - ".$adtype ?>] <?php echo number_format($sub_size,2,'.',',') ?></b></td>    
                                          <?php    
                                            break;
                       ...
                       <?php $section = $result[$ctr]["sub_type"] ?>   
                       <?php $adtype  = $result[$ctr]["ad_type"] ?> 
