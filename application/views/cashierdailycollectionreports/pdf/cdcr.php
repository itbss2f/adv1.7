...
<tbody>
    ...
    <?php for($ctr=0;$ctr<count($result);$ctr++) { ?>
     ...
     <tr  style="white-space: nowrap;">  
            ...
            <td style="text-align: center;width:100px;"><?php echo $result[$ctr]['or_num'] ?></td> 
            ...
            <td style="text-align: left;width:180px;"><?php echo $result[$ctr]['remarks'] ?></td>  
            ...
            <td style="text-align: center;width:80px;"><?php echo $result[$ctr]['adtype_code'] ?></td>
            
            <td style="text-align: center;width:80px;"><?php echo $result[$ctr]['baf_acct'] ?></td>
