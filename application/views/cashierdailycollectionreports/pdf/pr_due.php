...
<thead>
        <tr style="white-space: nowrap;">
            ...
            <th style="width:110px">Gov Status</th>
             
            <th style="width:220px">Remarks</th>
            
            <th style="width:110px">Cash</th>
            
            <th style="width:110px">Cheque Info</th>
            
            <th style="width:110px">Check No.</th>
            
            <th style="width:110px">Check Amount</th>
...
<tbody>
    ...
    <?php for($ctr=0;$ctr<count($result);$ctr++) { ?>
     ...
     <tr  style="white-space: nowrap;">  
            ...
            <td style="text-align: center;"><?php echo $result[$ctr]['amount'] ?></td>
