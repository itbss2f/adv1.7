...
<div class="workplace">
    <div class="row-fluid">
        ...
        <div class="block-fluid">                        
            <div class="row-form" style="padding: 2px 2px 2px 10px;">
                ...
                <div class="span2" style="width:100px;margin-top:12px">
                    <select name="reporttype" id="reporttype">
                        ...
                        <option value="7">Agency with Client</option>                           
                        <option value="2">Direct Ads</option>                        
                        <option value="3">Client</option>                        
                        <option value="4">Adtype</option>                        
                        <option value="10">AE Class</option>                        
                        <option value="11">AE Product</option>                        
                        <option value="12">AE Client</option>                        
                        <option value="5">Product</option>                        
                        <option value="6">Branch</option>                        
                        <option value="8">Client Section</option>                        
                        <option value="9">Section Client</option>                        
                                             
                    </select>
                </div>
                <div class="span2" style="width:55px;margin-top:12px">Pay Type</div>
                <div class="span2" style="width:100px;margin-top:12px">
                ...
                <div class="span2 vprod" style="width:50px;margin-top:12px;">Product</div>
                <div class="span2 vprod" style="width:100px;margin-top:12px;">
                    <select name="xproduct" id="xproduct">       
                        <option value="0">--All--</option>                                                          
                        <?php foreach ($products as $productx) : ?>
                        <option value="<?php echo $productx['id'] ?>"><?php echo $productx['prod_name'] ?></option>                                 
                        <?php endforeach; ?>                             
                    </select>
                </div>
            ...
            <div class="row-form" style="padding: 2px 2px 2px 10px;"> 
                <div class="span2 vprod" style="width:50px;margin-top:12px;">Retrieve</div>
                <div class="span2 vprod" style="width:100px;margin-top:12px;">
            ...
            <div class="row-form" style="padding: 2px 2px 2px 10px;">  
                ...
                <div class="span2 vproduct" style="width:150px;margin-top:12px;display: none;">
                    <select name="productto" id="productto">                    
                        <?php foreach ($products as $product2) : ?>
...
$("#reporttype").change(function(){
    ...
    if ($report == 4) {
        ...
        $('.vproduct').hide();
        $('.vbranch').hide();
    } else if ($report == 5 || $report == 10 || $report == 11) {
        $('.vadtype').hide();
        $('.vproduct').show();
        $('.vbranch').hide();
        $('.vprod').hide();
...
$("#generatereport").click(function(response) {
    ...
    $("#source").attr('src', "<?php echo site_url('salesrank_report/generatereport') ?>/"+datefrom+"/"+dateto+"/"+reporttype+"/"+bookingtype+"/"+toprank+"/"+adtypefrom+"/"+adtypeto+"/"+productfrom+"/"+productto+"/"+branchfrom+"/"+branchto+"/"+toprank+"/"+rettype+"/"+paytype+"/"+xproduct);     
...
$("#exportreport").die().live("click",function() {
    ...
    for (x = 0; x < validate_fields.length; x++) {            
       ...
       {
    window.open("<?php echo site_url('salesrank_report/exportreport/') ?>?datefrom="+datefrom+"&dateto="+dateto+"&bookingtype="+bookingtype+"&reporttype="+reporttype+"&toprank="+toprank+"&adtypefrom="+adtypefrom+"&adtypeto="+adtypeto+"&productfrom="+productfrom+"&productto="+productto+"&branchfrom="+branchfrom+"&branchto="+branchto+"&toprank="+toprank+"&rettype="+rettype+"&paytype="+paytype+"&xproduct="+xproduct, '_blank');
            window.focus();     
