    <div class="row-form" style="padding: 2px 2px 2px 10px;">
        ...
        <div style="font-size:13px ;text-align: left ;width:400px"><b>FORECAST CONTRIBUTION MARGIN (Section Per Issue)</b></div>
      ...
      <?php           
        foreach ($data["page"] as $z => $xx) {  ?>
            ...
            <tr>
                <td colspan="8" style="text-align: left;"><b><?php echo $z."  ".date("l, F d, Y", strtotime($xx[key($xx)]["issuedate"]))?></b></td> 
            </tr>
