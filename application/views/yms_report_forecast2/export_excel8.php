    <div class="row-form" style="padding: 2px 2px 2px 10px;">
        ...
        <div style="font-size:13px ;text-align: left ;width:400px"><b>FORECAST CONTRIBUTION MARGIN (Info for Dummied Ads)</b></div>
           ...
           /* $result[] = array(array("text" => "TOTAL", "bold" => true),
            ...
            ?>      
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;"><b><?php echo number_format($tpesoload, 0, ".", ",") ?></b></td>
                        <td style="text-align: right;"><b><?php echo $ttpesovstartget ?></b></td>
