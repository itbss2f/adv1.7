...
<?php foreach ($dlist as $sectionname => $xlist) : ?>  
    <tr>
        <b><td colspan = "20" style="background: #98AFC7; font-size: 14px; color: red; font-weight: 300"><b><?php if ($sectionname == '') { echo 'No Section'; } else { echo $sectionname; } ?></td>
    </tr>
    ...
    <?php if ($sectionname != '') : ?>
    <tr>
       <b><td colspan="8" style="text-align: right;background: #98AFC7; font-size: 14px; color: red; font-weight: 300"><b>SUBTOTAL : </b></td>
...
<?php endforeach; ?>   
    <tr>
        <b><td colspan="8" style="text-align: right;background: #98AFC7; font-size: 14px; color: red; font-weight: 300"><b>GRANDTOTAL : </b></td>
