<?php
  ...
  class Cancelledais Extends CI_Model
  {
      
      public function cancelled_ai_advertising_detail($data)
      {
                    ...
                    WHERE (b.ao_sidate BETWEEN '".$data['from_date']."' AND '".$data['to_date']."')
                    AND e.adtype_code = 'M'
                    AND b.ao_rfa_aistatus = 'C' ";
       ...
       public function cancelled_ai_advertising($data)
      {
                    $stmt = "SELECT b.ao_sinum,
                           DATE(b.ao_sidate) as ao_sidate,
                           c.cmf_name AS client_name,
