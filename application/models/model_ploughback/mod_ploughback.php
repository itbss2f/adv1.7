...
class Mod_Ploughback extends CI_Model {
    ...
    public function getReport($datefrom, $dateto, $reporttype, $vdays, $agencyfrom, $c_clientfrom, $ac_agency, $ac_client) {
        ...
        $stmt = "
                 SELECT z.*, FORMAT(aogrossamt, 2) AS aogrossamtx, FORMAT(aoagycommamt, 2) AS aoagycommamtx,
                ...
                SELECT m.ao_amf, m.ao_cmf, m.ao_payee, a.ao_sinum AS invnum, DATE(a.ao_sidate) AS invdate, 
                       ...
                       '' AS ornum, '' AS ordate, '' AS orassignamt, 0 AS  orassigngrossamt , 0 AS netdmcm, '' AS pastdue
                FROM ao_p_tm AS a              
                ...
                SELECT m.ao_amf, m.ao_cmf, m.ao_payee, a.ao_sinum AS invnum, DATE(a.ao_sidate) AS invdate, 
                       ...
                       (od.or_assignamt) AS orassignamt, (od.or_assigngrossamt) AS orassigngrossamt, 0,
                ...
                SELECT m.ao_amf, m.ao_cmf, m.ao_payee, a.ao_sinum AS invnum, DATE(a.ao_sidate) AS invdate, 
                       ...
                       IFNULL(od.dc_assigngrossamt, 0) AS netdmcm,
                ...
                AND om.dc_subtype IN (15,16,11,12,1,4)
                $con
                UNION
                SELECT m.ao_amf, m.ao_cmf, m.ao_payee, a.ao_sinum AS invnum, DATE(a.ao_sidate) AS invdate, 
                       '', '', 0, '',
                ...
                AND om.dc_subtype IN (15,16,11,12,1,4)
                $con
                ORDER BY invnum, invdate, ordate) AS z
                ";
