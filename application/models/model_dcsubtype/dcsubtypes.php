...
class DCSubtypes extends CI_Model {
    ...
    public function thisDCSubtype($id) {
        $stmt = "SELECT misdcsubtype.id, misdcsubtype.dcsubtype_code, misdcsubtype.dcsubtype_name, misdcsubtype.dcsubtype_group, misdcsubtype.dcsubtype_apply, 
                       ...
                       misdcsubtype.dcsubtype_credit1, misdcsubtype.dcsubtype_credit2, misdcsubtype.dcsubtype_part, misdcsubtype.dcsubtype_vold_others,
                       misdcsubtype.dcsubtype_vold_dmcm_cm, misdcsubtype.dcsubtype_vold_dmcm_dm
                FROM misdcsubtype 
    ...
    function search($searchkey)
    {
       $stmt = "SELECT misdcsubtype.id, misdcsubtype.dcsubtype_code, misdcsubtype.dcsubtype_name, misdcsubtype.dcsubtype_group, misdcsubtype.dcsubtype_apply, 
                       ...
                       misca3.caf_code AS dcsubtype_credit1, misca4.caf_code AS dcsubtype_credit2, misdcsubtype.dcsubtype_part, misdcsubtype.dcsubtype_vold_others,
                       misdcsubtype.dcsubtype_vold_dmcm_cm, misdcsubtype.dcsubtype_vold_dmcm_dm
                FROM misdcsubtype 
                ...
                (
                 ...
                 OR misdcsubtype.dcsubtype_vold_others LIKE '".$searchkey."%'
                 OR misdcsubtype.dcsubtype_vold_dmcm_cm LIKE '".$searchkey."%'
                 OR misdcsubtype.dcsubtype_vold_dmcm_dm LIKE '".$searchkey."%'
    ...
    public function listOfDCSubtype() {
        ...
        $stmt = "SELECT b.caf_code AS debit1, c.caf_code AS debit2, 
                ...
                WHERE a.is_deleted = '0' ORDER BY a.dcsubtype_name ASC";
     ...
     public function searched($searchkey)
    {
        ...
        if ($searchkey['dcsubtype_vold_others'] != "") {$conothers = "AND a.dcsubtype_vold_others LIKE '".$searchkey['dcsubtype_vold_others']."%'"; }
        if ($searchkey['dcsubtype_vold_dmcm_cm'] != "") {$condmcm_cm = "AND a.dcsubtype_vold_dmcm_cm LIKE '".$searchkey['dcsubtype_vold_dmcm_cm']."%'"; }
        if ($searchkey['dcsubtype_vold_dmcm_dm'] != "") {$condmcm_dm = "AND a.dcsubtype_vold_dmcm_dm LIKE '".$searchkey['dcsubtype_vold_dmcm_dm']."%'"; }
      ...
      $stmt = "SELECT a.id, a.dcsubtype_code, a.dcsubtype_name, a.dcsubtype_group,
                    ...
                    a.dcsubtype_vold_others,
                    a.dcsubtype_vold_dmcm_cm,
                    a.dcsubtype_vold_dmcm_dm,
                    ...
                    WHERE a.is_deleted = 0 $concode $conname $concatad $conclass $conacct $contype $conpart $cona $conb $conc $cond $conothers $condmcm_cm $condmcm_dm"; 
