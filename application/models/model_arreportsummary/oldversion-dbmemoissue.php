...
class Mod_arreportsummary extends CI_Model {
    ...
    public function query_report($find) {    
        ...
        switch ($reporttype) {
            ...
            case 11:
                ...
                $stmt = "SELECT 
                               SUBSTR(CONCAT(clientname, ' ',clientcode), 1, 45) AS particular, 
                        ...
                        FROM age_tmp_tbl  WHERE hkey = '5exTNIdK2015010712012323115'
                        GROUP BY clientcode
                        ORDER BY clientname";
    ...
    public function query_stmt($dateasof, $reporttype, $dateasfrom) {
        ...
        foreach ($result as $row) {
            ...
            if (($reporttype == 1 || $reporttype == 3 || $reporttype == 5 || $reporttype == 6 || $reporttype == 7 || $reporttype == 9 || $reporttype == 10) ? $ageamt = $row['bal'] : $ageamt = $row['balnovat'] );            
