...
class Paycheckbankbranches extends CI_Model
{
    public function __construct()
    {
     ...
     public function removeData($id) {
        ...
        $this->db->where('id', $id);
        $this->db->update('mispaycheckbankbranch', $data);
    ...
    public function getData($id) {
        $stmt = "SELECT id, bbf_bank, bbf_bnch, bbf_add1, bbf_tel1, bbf_name FROM mispaycheckbankbranch WHERE id = '$id' AND is_deleted = 0";
    ...
    public function saveNewData($data) {
        ...
        $data['edited_n'] = $this->session->userdata('authsess')->sess_id;
        $data['edited_d'] = DATE('Y-m-d h:i:s');   
        $this->db->insert('mispaycheckbankbranch', $data);  
    ...
    public function listOfBankBranchInBank($bff_bank) 
    {
        $stmt = "SELECT a.id,a.bbf_bank, a.bbf_bnch, a.bbf_add1, a.bbf_add2, a.bbf_add3, a.bbf_tel1, a.bbf_tel2,
                ...
                FROM mispaycheckbankbranch AS a
                INNER JOIN mispaycheckbank AS b ON a.bbf_bank = b.id WHERE a.bbf_bank = '".$bff_bank."' AND a.is_deleted = '0' AND b.is_deleted = '0'";
    ...
    {
        $stmt = "UPDATE mispaycheckbankbranch SET is_deleted = '1', status_d = NOW() WHERE id = '".$id."'";
        $this->db->query($stmt);
        return TRUE;
    }
    ...
    public function updateBankBranch($data)
    {
        ...
        $stmt = "UPDATE mispaycheckbankbranch SET bbf_bank = '".$data['bbf_bank']."', bbf_bnch = '".$data['bbf_bnch']."', 
    ...
    public function thisBankBranch($id)
    {
        $stmt = "SELECT a.id,a.bbf_bank, a.bbf_bnch, a.bbf_add1, a.bbf_add2, a.bbf_add3, a.bbf_tel1, a.bbf_tel2,
                ...
                FROM mispaycheckbankbranch AS a
                INNER JOIN mispaycheckbank AS b ON a.bbf_bank = b.id
                WHERE a.id = '".$id."'";
        $result = $this->db->query($stmt)->row_array();
        return $result;
    }
    ...
    {                
        ...
        $stmt = "INSERT INTO mispaycheckbankbranch (bbf_bank, bbf_bnch, bbf_add1,bbf_add2,bbf_add3,bbf_tel1,bbf_tel2,
    ...
    public function listOfBankBranch() 
    {
        $stmt = "SELECT a.id,a.bbf_bank, a.bbf_bnch, a.bbf_add1, a.bbf_add2, a.bbf_add3, a.bbf_tel1, a.bbf_tel2,
                ...
                FROM mispaycheckbankbranch AS a
                INNER JOIN mispaycheckbank AS b ON a.bbf_bank = b.id WHERE a.is_deleted = '0' AND b.is_deleted = '0' ORDER BY id desc";
        $result = $this->db->query($stmt)->result_array();
        return $result;
    }
    ...
    public function listOfBankBranchDESC($stat, $offset, $limit) 
    {
        $stmt = "SELECT a.id,a.bbf_bank, a.bbf_bnch, a.bbf_add1, a.bbf_add2, a.bbf_add3, a.bbf_tel1, a.bbf_tel2,
                ...
                FROM mispaycheckbankbranch AS a
                INNER JOIN mispaycheckbank AS b ON a.bbf_bank = b.id WHERE a.is_deleted = '0' ORDER BY id desc LIMIT 25 OFFSET $offset";
        $result = $this->db->query($stmt)->result_array();
        return $result;
    }
    ...
    public function countAll()
    {
       $stmt = "SELECT count(a.id) as count_id
                FROM mispaycheckbankbranch AS a
                INNER JOIN mispaycheckbank AS b ON a.bbf_bank = b.id WHERE a.is_deleted = '0'";
    ...
    public function searched($searchkey)
    {
        ...
        $stmt = "SELECT a.id, a.bbf_bnch, a.bbf_add1, a.bbf_tel1, a.bbf_name, b.bmf_name
                        FROM mispaycheckbankbranch AS a
                        LEFT OUTER JOIN mispaycheckbank AS b ON b.id = a.bbf_bank
