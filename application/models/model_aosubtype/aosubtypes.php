<?php
    ...
    class Aosubtypes Extends CI_Model
    {
            ...
            {
                $stmt = "SELECT aosubtype_code, aosubtype_name, aosubtype_spontag FROM misaosubtype WHERE id = '".$id."'";
            ...
            public function listOfAOSubType() 
            {
                $stmt = "SELECT id , aosubtype_code, aosubtype_name,
                               CASE aosubtype_spontag
                               WHEN 1 THEN 'YES'
                               ELSE 'NO'
                               END AS spontag 
                        FROM misaosubtype WHERE is_deleted = '0' ORDER BY aosubtype_code ASC";
