<?php
    ...
    class Cmschedsummary extends CI_Controller
    {
        function __construct()
        {
            ...
            $this->load->model(array("model_cmschedsummaries/Cmschedsummaries"));
        }
        ...
        function index()
        {
           ...
           $navigation['data'] = $this->GlobalModel->moduleList();         
            ...
            $layout['content'] = $this->load->view("cmschedsummary/index",$data,true);        
        ...
        function generateReport()
        {
           ...
           $data['data'] = array(
            ...
            $html = $this->load->view("cmschedsummary/reports/object",$data,true);
       ...
       {      
            ...
            $data['result'] = $this->Cmschedsummaries->$report_type($data);    
                        
            $html = $this->load->view("cmschedsummary/reports/result",$data,true);
