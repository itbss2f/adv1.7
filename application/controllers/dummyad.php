<?php
  ...
  class Dummyad extends CI_Controller
  {
      ...
      function __construct()
      {
          ...
          $this->load->model('model_dummyads/Dummyads');
      }
      ...
      function index()
      {
            ...
            $data['report']      = array(
                                         ...
                                         array('value'=>'Dummyads:dummied_ads','type'=>'Dummied Ads'),
                                         
                                         array('value'=>'Dummyads:undummied_ads','type'=>'Undummied Ads'),
                                         
                                         array('value'=>'Dummyads:blockout','type'=>'Blockout'),
                                         
                                         array('value'=>'Dummyads:dummied_undummied_ads','type'=>'Dummied and Undummied')
            ...
            $layout['content'] = $this->load->view("dummyads/index",$data,true); 
      ...
      public function generateReport()
      {
        $data['data'] = array(
         ...
         $html = $this->load->view("dummyads/reports/object",$data,true);
      ...
      {      
            ...
            $html = $this->load->view("dummyads/reports/".$function,$data,true);
