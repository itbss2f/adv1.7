		...
		if (myprod == "" || mydate == "") {		
			...
			if ($numberofpage == "" || $numberofpage == "0") {
				...
				$.ajax({
					...
					type: 'post',
					data: {bookname: $(":input[name='bookname']").val(), numberofpage: $(":input[name='numberofpage']").val(),  key: mykey, product: myprod, date: mydate, viewing: $("#viewing").val(), color: "0", class_code: ""},
