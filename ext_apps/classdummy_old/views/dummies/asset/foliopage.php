...
<script>
	...
	$("#okfolio").click(function(){
		if ($("#folionumber").val() != "") {
			$.ajax({
				url: '<?php echo site_url('classdummy/dummy/ajxSetFolio') ?>',
				type: 'post',
	...
	$("#okblockout").click(function(){		
			...
			if (reservewidth == "" || reserveheight == "" || reservedescription == "") {
				...
				$.ajax({
					url: '<?php echo site_url('classdummy/dummy/addblockout') ?>',
					type: 'post',
					data: {key: '<?php echo $key ?>', product: '<?php echo $product ?>', date: '<?php echo $date ?>', 
	...
	$("#mergepage").click(function(){
		$.ajax({
			url: '<?php echo site_url('classdummy/dummy/ajxmergePage') ?>',
			type: 'post',
			data: {key: '<?php echo $key ?>', product: '<?php echo $product ?>', date: '<?php echo $date ?>', 
	...
	$("#unmergepage").click(function(){
		$.ajax({
			url: '<?php echo site_url('classdummy/dummy/ajxUnmergePage') ?>',
			type: 'post',
			data: {key: '<?php echo $key ?>', product: '<?php echo $product ?>', date: '<?php echo $date ?>', 
				   pageID: '<?php echo $pageID ?>', viewing: '<?php echo $viewing ?>'},
			success: function(response) {	
