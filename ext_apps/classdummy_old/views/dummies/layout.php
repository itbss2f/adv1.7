...
<body>      
    <div class="container"><!-- container -->        
        <div class="nav">    
            <div id="nav1">  
                <?php if($canDUMOPEN) : ?>
                <div class="toolkit"><a href="<?php echo site_url('classdummy/dummy/opend') ?>" title="Open Dummy" rel="facebox"><img src="<?php echo base_url() ?>assets/images/dummy/open.png" border="0"></a></div>
                <?php endif; ?>            
                <?php if($canDUMSAVE) : ?>
                ...
                <?php endif; ?>
                <?php if($canDUMADDSEC) : ?>
                <div class="toolkit"><a href="<?php echo site_url('classdummy/dummy/sectiond') ?>" title="Set Section" rel="facebox"><img src="<?php echo base_url() ?>assets/images/dummy/section.png" border="0"></a></div>
                <?php endif; ?>
                <?php if($canDUMCOLOR) : ?>
                <div class="toolkit"><a href="<?php echo site_url('classdummy/dummy/colord') ?>" title="Set Color" rel="facebox"><img src="<?php echo base_url() ?>assets/images/dummy/color.png" border="0"></a></div>
                  <?php endif; ?>
                <?php if($canDUMADDPAGE) : ?>
                <div class="toolkit"><a href="<?php echo site_url('classdummy/dummy/addpaged') ?>" title="Add New Page" rel="facebox"><img src="<?php echo base_url() ?>assets/images/dummy/addpage.png" border="0"></a></div>
                <?php endif; ?>
                <?php if($canDUMCOLOR) : ?>
                ...
                <?php endif; ?>
                <!-- <div class="toolkit"><a href="<?php echo site_url('classdummy/dummy/merged') ?>" title="Merged Page" id="merged" name="merged" rel="facebox"><img src="<?php echo base_url() ?>images/dummy/merged.png" border="0"></a></div>            -->        
                <?php if($canDUMCOLOR) : ?>
        ...
        <div class="contentdummy">
            <div id="content1"></div>
            <div id="content2">
                <div id="content2-header">List of Ad: [<strong id="dateofissue">No Issue Date</strong>]<a href='#hide' style='font-size:10px' id='header_hide'>Hide</a><a href='#unhide' id='header_unhide' style='display:none;font-size:10px'>Unhide</a></div>
                ...
                <div id="content2-content" style="height: 250px;"></div>                
                <div id="content2-header" style="height: 143px; background: none repeat scroll 0 0 #EDEDED; overflow: auto;">
                    <table id="myTable2" class="tablesorter" style='font-size:11px;'>  
                        <thead> 
                            <tr> 
                                <th style='width:20px'>BOX</th>
                                <th style='width:250px' align="center">Line Header</th>                                                
                            </tr> 
                        </thead> 
                        <tbody>
                        <?php foreach ( $classhead as $classhead ) :?>
                            <tr>                                                                        
                                <td colspan="2"><div class="draggablebox" style="background: #F781BE; width: 100%;" id="H:<?php echo $classhead["id"] ?>"><?php echo $classhead["class_name"] ?></div></td>                                
                            </tr>
                        <?php endforeach; ?>
                        </tbody>   
                    </table>
    ...
    <div id="prod_remark" title="PRODUCTION REMARKS"></div>   
    ...
    <script type="text/javascript">    
        ...
        $("#save").click(function(){
            ...
            if (product == "" || date == "") {
                ...
                if (conf) {
                    $("#selection").val("");  
                    $.ajax({
                        url: '<?php echo site_url('classdummy/dummy/saveDummyData'); ?>',
                        type: 'post',
        ...
        $("#refresh").click(function(){
            if (product == "" || date == "") {
                ...
                $.ajax({
                    url: '<?php echo site_url('classdummy/dummy/ajxRefresh'); ?>',
                    type: 'post',
        ...
        $("#viewing").change(function(){
            ...
            if (product == "" || date == "") {                
                ...
                $.ajax({
                url: '<?php echo site_url('classdummy/dummy/ajaxViewingPercent')?>',
                type: 'post',
                data: {key: key,
                       viewing: $("#viewing").val(),
                       product: product,
        ...
        function filtering() {
            ...
            $.ajax({
                url: '<?php echo site_url('classdummy/dummy/ajxFiltering') ?>',
                type: 'post',
                data: {product: myprod,
                       dateissue: mydate,
                       section: section, 
        ...
        $("#print").click(function(){    
            ...
            window.open ("<?php echo site_url('classdummy/dummy_layout/printout')?>/"+date+"/"+product+"","Dummy Print Output","menubar=1,resizable=1");
        });
        ...
        $("#multiadd").click(function() {
             if ($("#multipages").val() == "" || $("#multipages").val() == 0) {
                alert("Page number should not be zero or empty!.");    
                 ...
                 $.ajax({
                    url : '<?php echo site_url('classdummy/dummy/ajxAddPage') ?>',
                    type: 'post',
        ...
        function selectIssueDate(dateText, inst) {
            if (dateText == date) {
                ...
                if (ans) {
                    $.ajax({
                        url: "<?php echo site_url('classdummy/dummy/makeTemplate') ?>",
                        type: 'post',
        ...
        function loadthetemplate(dateText) {
            ...
            $.ajax({
                url: '<?php echo site_url('classdummy/dummy/ajxRtAds')?>',
                type: 'post',
