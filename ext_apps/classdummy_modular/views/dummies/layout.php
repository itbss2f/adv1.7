...
<head>    
    ...
    <title>Dummy Classifieds [PDI] MODULAR</title>
...
<body>      
    <div class="container"><!-- container -->        
        <div class="nav">    
            <div id="nav1">  
                <?php if($canDUMOPEN) : ?>
                <div class="toolkit"><a href="<?php echo site_url('classdummy_modular/dummy/opend') ?>" title="Open Dummy" rel="facebox"><img src="<?php echo base_url() ?>assets/images/dummy/open.png" border="0"></a></div>
                <?php endif; ?>            
                <?php if($canDUMSAVE) : ?>
                ...
                <?php endif; ?>
                <?php if($canDUMADDSEC) : ?>
                <div class="toolkit"><a href="<?php echo site_url('classdummy_modular/dummy/sectiond') ?>" title="Set Section" rel="facebox"><img src="<?php echo base_url() ?>assets/images/dummy/section.png" border="0"></a></div>
                <?php endif; ?>
                <?php if($canDUMCOLOR) : ?>
                <div class="toolkit"><a href="<?php echo site_url('classdummy_modular/dummy/colord') ?>" title="Set Color" rel="facebox"><img src="<?php echo base_url() ?>assets/images/dummy/color.png" border="0"></a></div>
                  <?php endif; ?>
                <?php if($canDUMADDPAGE) : ?>
                <div class="toolkit"><a href="<?php echo site_url('classdummy_modular/dummy/addpaged') ?>" title="Add New Page" rel="facebox"><img src="<?php echo base_url() ?>assets/images/dummy/addpage.png" border="0"></a></div>
                <?php endif; ?>
                <?php if($canDUMCOLOR) : ?>
                ...
                <?php endif; ?>
                <!-- <div class="toolkit"><a href="<?php echo site_url('classdummy_modular/dummy/merged') ?>" title="Merged Page" id="merged" name="merged" rel="facebox"><img src="<?php echo base_url() ?>images/dummy/merged.png" border="0"></a></div>            -->        
                <?php if($canDUMCOLOR) : ?>
    ...
    $('#budget').click(function(){
        ...
        $("#save").click(function(){
            ...
            if (product == "" || date == "") {
                ...
                if (conf) {
                    ...
                    $.ajax({
                        url: '<?php echo site_url('classdummy_modular/dummy/saveDummyData'); ?>',
                        type: 'post',
        ...
        $("#refresh").click(function(){
            if (product == "" || date == "") {
                ...
                $.ajax({
                    url: '<?php echo site_url('classdummy_modular/dummy/ajxRefresh'); ?>',
                    type: 'post',
        ...
        $("#viewing").change(function(){
            ...
            if (product == "" || date == "") {                
                ...
                $.ajax({
                url: '<?php echo site_url('classdummy_modular/dummy/ajaxViewingPercent')?>',
                type: 'post',
                data: {key: key,
                       viewing: $("#viewing").val(),
                       product: product,
        ...
        function filtering() {
            ...
            $.ajax({
                url: '<?php echo site_url('classdummy_modular/dummy/ajxFiltering') ?>',
                type: 'post',
                data: {product: myprod,
                       dateissue: mydate,
                       section: section, 
        ...
        $("#print").click(function(){    
            ...
            window.open ("<?php echo site_url('classdummy_modular/dummy_layout/printout')?>/"+date+"/"+product+"","Dummy Print Output","menubar=1,resizable=1");
        });
        ...
        $("#multiadd").click(function() {
             if ($("#multipages").val() == "" || $("#multipages").val() == 0) {
                alert("Page number should not be zero or empty!.");    
                 ...
                 $.ajax({
                    url : '<?php echo site_url('classdummy_modular/dummy/ajxAddPage') ?>',
                    type: 'post',
        ...
        function selectIssueDate(dateText, inst) {
            if (dateText == date) {
                ...
                if (ans) {
                    $.ajax({
                        url: "<?php echo site_url('classdummy_modular/dummy/makeTemplate') ?>",
                        type: 'post',
        ...
        function loadthetemplate(dateText) {
            ...
            $.ajax({
                url: '<?php echo site_url('classdummy_modular/dummy/ajxRtAds')?>',
                type: 'post',
