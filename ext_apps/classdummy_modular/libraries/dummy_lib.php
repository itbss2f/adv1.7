...
class Dummy_Lib {
    ...
    function create_layout($color, $papersize, $constant, $data, $randname) {
        ...
        for ($c = 1; $c < $cons['column']; $c++) {
            ...
            imagedashedline($im, $col_new_point - $cons['gutter_per_pixel'], 300, $col_new_point - $cons['gutter_per_pixel'], $paper_size['length'] - 80, $grey);    
            #imagedashedline($im, $col_new_point, 300, $col_new_point, $paper_size['length'] - 202, $grey);        
            imagedashedline($im, $col_new_point, 300, $col_new_point, $paper_size['length'] - 80, $grey);        
            $col_new_point += $cols;
        } 
